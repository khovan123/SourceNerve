...
<p align="center">
  <img alt="Version" src="https://img.shields.io/badge/version-0.1.29-7c3aed?style=flat-square" />
...
> Current application/daemon version: **0.1.29**
...
`0.1.29` treats SourceNerve as a **Harness shell and Desktop runtime** for AI-assisted repository work: workspace security, native Codex/ChatGPT execution, supervised closed-loop verification, durable mutation guards, Git/provider workflows, plugin/MCP composition, approvals, audit, recovery, jobs, callbacks, diagnostics, and release/security operations are core.
...
`0.1.29` makes explicit commit-and-push requests replay-safe through one guarded Git operation and hardens ChatGPT Web Project creation against current project-name editor and Create-button DOM variants.
