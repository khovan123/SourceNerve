...
required_scopes = {
    "openid", "profile", "email", "offline_access", "sourcenerve:read", "sourcenerve:write"
}
...
if cloudflare.get("mode") == "broker-managed" and cloudflare.get("desktopReceivesInstallationCredential") is not True:
