...
struct RecoveryFacts {
    ...
    base_head: String,
    current_head: String,
    run_graph_version: i64,
    current_graph_version: i64,
    run_indexed_head: Option<String>,
    current_indexed_head: Option<String>,
...
pub(super) async fn inspect(
    ...
    let facts = RecoveryFacts {
        ...
        run_graph_version: row.graph_version,
        current_graph_version: current.graph_version,
        run_indexed_head: row.indexed_head.clone(),
