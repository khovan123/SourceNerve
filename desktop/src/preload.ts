...
const api: SourceNerveDesktopApi = {
  ...
  getDesktopControlState: () => ipcRenderer.invoke(DESKTOP_IPC.desktopControlState) as Promise<DesktopResult<DesktopControlState>>,
  updateDesktopControlPermissions: (permissions: DesktopControlPermissions) => ipcRenderer.invoke(DESKTOP_IPC.desktopControlPermissionsUpdate, permissions) as Promise<DesktopResult<DesktopControlState>>,
  observeDesktop: (input: DesktopControlObserveInput = {}) => ipcRenderer.invoke(DESKTOP_IPC.desktopControlObserve, input) as Promise<DesktopResult<DesktopControlObservation>>,
  runDesktopControl: (input: DesktopControlRunInput) => ipcRenderer.invoke(DESKTOP_IPC.desktopControlRun, input) as Promise<DesktopResult<DesktopControlRunResult>>,
  getChromeExtensionBridgeState: () => ipcRenderer.invoke(DESKTOP_IPC.chromeExtensionBridgeState) as Promise<DesktopResult<ChromeExtensionBridgeState>>,
  rotateChromeExtensionBridgeToken: () => ipcRenderer.invoke(DESKTOP_IPC.chromeExtensionBridgeRotateToken) as Promise<DesktopResult<ChromeExtensionBridgeState>>,
  ...
  runHarnessCommand: (input: DesktopHarnessCommandInput) => ipcRenderer.invoke(HARNESS_IPC.commandExecute, input) as Promise<DesktopResult<DesktopHarnessCommandView>>,
  ...
  getHarnessCodexStatus: (input: DesktopHarnessCodexStatusInput) => ipcRenderer.invoke(HARNESS_IPC.codexStatus, input) as Promise<DesktopResult<DesktopHarnessCodexStatusView>>,
  getHarnessCodexUsage: (input: DesktopHarnessCodexUsageInput) => ipcRenderer.invoke(HARNESS_IPC.codexUsage, input) as Promise<DesktopResult<DesktopHarnessCodexUsageView>>,
  getHarnessCodexConversation: (input: DesktopHarnessCodexConversationInput) => ipcRenderer.invoke(HARNESS_IPC.codexConversation, input) as Promise<DesktopResult<DesktopHarnessCodexConversationView>>,
  listHarnessCodexConversations: (input: DesktopHarnessCodexConversationListInput) => ipcRenderer.invoke(HARNESS_IPC.codexConversationList, input) as Promise<DesktopResult<DesktopHarnessCodexConversationSummary[]>>,
  clearHarnessCodexConversations: (input: DesktopHarnessCodexConversationClearInput) => ipcRenderer.invoke(HARNESS_IPC.codexConversationClear, input) as Promise<DesktopResult<DesktopHarnessCodexConversationClearResult>>,
  resumeHarnessCodexConversation: (input: DesktopHarnessCodexConversationResumeInput) => ipcRenderer.invoke(HARNESS_IPC.codexConversationResume, input) as Promise<DesktopResult<DesktopHarnessCodexConversationView>>,
  prepareHarnessCodexTurn: (input: DesktopHarnessCodexTurnPrepareInput) => ipcRenderer.invoke(HARNESS_IPC.codexTurnPrepare, input) as Promise<DesktopResult<DesktopHarnessCodexTurnPreparationView>>,
  ...
  runHarnessCodexReviewLoop: (input: DesktopHarnessCodexReviewLoopInput) => ipcRenderer.invoke(HARNESS_IPC.codexReviewLoop, input) as Promise<DesktopResult<DesktopHarnessCodexReviewLoopView>>,

  createHarnessAgentWorkerFamily: (input: DesktopHarnessAgentWorkerFamilyCreateInput) => ipcRenderer.invoke(HARNESS_IPC.agentWorkerFamilyCreate, input) as Promise<DesktopResult<DesktopHarnessAgentWorkerFamilyView>>,
  getHarnessAgentWorkerFamily: (input: DesktopHarnessAgentWorkerFamilyGetInput) => ipcRenderer.invoke(HARNESS_IPC.agentWorkerFamilyGet, input) as Promise<DesktopResult<DesktopHarnessAgentWorkerFamilyView>>,
  runHarnessAgentWorker: (input: DesktopHarnessAgentWorkerRunInput) => ipcRenderer.invoke(HARNESS_IPC.agentWorkerRun, input) as Promise<DesktopResult<DesktopHarnessAgentWorkerRunView>>,
  ...
  mergeProviderPull: (input: ProviderPullMergeActionInput) => ipcRenderer.invoke(PROVIDER_WORKFLOW_IPC.pullMerge, input) as Promise<DesktopResult<ProviderPullActionResult>>,
  closeProviderPull: (input: ProviderPullCloseActionInput) => ipcRenderer.invoke(PROVIDER_WORKFLOW_IPC.pullClose, input) as Promise<DesktopResult<ProviderPullActionResult>>,
  commentProviderPull: (input: ProviderPullCommentActionInput) => ipcRenderer.invoke(PROVIDER_WORKFLOW_IPC.pullComment, input) as Promise<DesktopResult<ProviderPullCommentActionResult>>,
