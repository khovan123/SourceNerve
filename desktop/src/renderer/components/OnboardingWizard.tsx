      ...
      <header className="relative overflow-hidden rounded-2xl border border-border bg-card/75 p-4 shadow-[0_18px_45px_rgba(40,34,26,0.05)] backdrop-blur-sm sm:p-5">
        ...
        <div className="relative flex flex-col gap-4 sm:flex-row sm:items-start sm:justify-between">
          <div className="min-w-0">
            ...
            <p className="mt-2 max-w-3xl text-sm leading-6 text-muted-foreground">Install or detect Codex, sign in with ChatGPT, add a local workspace, then open Harness and chat. Optional cloud/provider integrations can be connected later.</p>
          </div>
