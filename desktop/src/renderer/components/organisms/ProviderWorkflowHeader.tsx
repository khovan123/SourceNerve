  ...
  return (
    <div className="space-y-3">
      <div className="flex items-start gap-2 px-1 text-[11px] leading-5 text-muted-foreground">
        ...
        <p className="m-0 min-w-0"><strong className="font-semibold text-foreground">Provider constraints are authoritative.</strong> Branch protection, required checks, reviews, permissions and exact-head guards are always enforced.</p>
      </div>
