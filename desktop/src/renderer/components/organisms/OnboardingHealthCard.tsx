...
export function OnboardingHealthCard({ layers }: { layers: Array<{ id: OnboardingLayer; state: LayerState }> }) {
  return (
    <SurfaceCard title="Setup health" eyebrow="Runtime layers">
...
export function OnboardingStatusLine({ label, state }: { label: string; state: LayerState }) {
  ...
  return (
    <div className="flex min-h-11 items-center justify-between gap-3 rounded-xl border border-border bg-muted/20 px-3 py-2">
